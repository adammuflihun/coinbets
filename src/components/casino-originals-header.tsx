...
function UnicornBackground() {
  ...
  return (
    ...
    >
      <div
        data-us-project="rTFMVHVPW11hOtgodJhX"
...
export function CasinoOriginalsHeader() {
  return (
    <section
      data-section="casino-originals-header"
      ...
      <div data-name="header-content" className="relative z-10 flex flex-col items-center gap-10 px-5 py-16 sm:py-20 lg:py-24 pointer-events-none">
        ...
        <div data-name="header-text" className="flex flex-col items-center gap-5">
          ...
          <h1 className="text-3xl sm:text-[40px] lg:text-[45px] font-black text-white text-center leading-none tracking-tight">
            Crypto Casino Originals
          </h1>
          <p data-name="header-subtitle" className="max-w-[545px] text-base text-white text-center leading-[26px]">
            Compare original casino games by RTP, provably fair coverage, and
            implementation.
          </p>
        </div>

        {/* Buttons */}
        <div data-name="header-buttons" className="flex flex-col sm:flex-row items-center justify-center gap-5 w-full sm:w-auto pointer-events-auto">
          <Link
            href="/reviews"
            className="flex items-center justify-center gap-2 rounded-lg bg-[#e6b830] px-6 py-2.5 min-h-[40px] w-full sm:w-auto text-sm font-bold text-[#101010] hover:bg-[#d4a82a] transition-colors"
          >
          ...
          <Link
            href="#how-it-works"
            className="flex items-center justify-center gap-2 rounded-lg bg-[#f5f5f5] px-6 py-2.5 min-h-[40px] w-full sm:w-auto text-sm font-bold text-[#171717] hover:bg-[#e8e8e8] transition-colors"
          >
            How the Index Works
