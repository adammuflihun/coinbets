...
function ReviewCard({ review }: { review: (typeof reviews)[number] }) {
  return (
    <div
      ...
      className="flex flex-col gap-3.5 rounded-lg border border-neutral-200 bg-white p-5 shadow-sm flex-1"
    >
      {/* Casino header */}
      <div
      ...
      <div className="mt-auto flex flex-col gap-3.5">
        ...
        >
          <div data-name="bonus-info" className="flex items-center gap-1.5">
            <svg width="19" height="20" viewBox="0 0 19 20" fill="none" className="size-5 shrink-0">
